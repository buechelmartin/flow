...
if __name__ == "__main__":
    ...
    # hyper-parameters that are set to default
    config["schedule_max_timesteps"] = 1000000  # TODO: set to default
    config["train_batch_size"] = 100
    config["critic_hiddens"] = [300, 300]
    config["actor_hiddens"] = [300, 300]
    ...
    exp_tag = {
        ...
        "checkpoint_freq": 10,  # checkpoint every 50,000 steps
        "max_failures": 999,
        "stop": {
            "training_iteration": 2000  # for 10,000,000 steps
        },
        "num_samples": 3,
